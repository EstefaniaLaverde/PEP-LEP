"""
prototype_utils_v1.py

ARCHIVED / SUPERSEDED - kept for history only, nothing else imports this.
Renamed from idea/utils.py. Earliest exploratory utility module for the
LCE problem (solution-checking, low-weight sampling, etc.), from before
instances_generator.py / core/LEP_prediction_and_repair_v2.py existed.
See also prototype_utils_v2/v3/v4.py (from the old idea2/ folder) for
later iterations of the same exploration.
"""
