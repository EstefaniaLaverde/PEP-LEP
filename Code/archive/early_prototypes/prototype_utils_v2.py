#!/usr/bin/env sage
"""
prototype_utils_v2.py

ARCHIVED / SUPERSEDED - kept for history only, nothing else imports this.
Renamed from idea2/utils.py. Second-generation exploratory utility module
(condensed rewrite of prototype_utils_v1.py) - see prototype_utils_v3.py
and prototype_utils_v4.py for the next iterations, and
core/instances_generator.py / core/LEP_prediction_and_repair_v2.py for the
current, actively-used implementation these prototypes led to.
"""
